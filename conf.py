...
BLOG_AUTHOR = "Rodney Price"  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<style>body{background-image:url(/images/topography.png);}</style>"
...
# How to view comment count: place the following code before your
# site's closing </body> tag.

# <script id="dsq-count-scr" src="//shiny-penny.disqus.com/count.js" async></script>
...
# See also https://help.disqus.com/customer/portal/articles/565624 for
# help adding comment counts to the home page.
...
#     s.src = 'https://shiny-penny.disqus.com/embed.js';
